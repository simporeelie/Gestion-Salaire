...
<h1 class="app-page-title">Departement</h1>
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter un nouveau departement ici. </div>
	                </div>
                            ...
                            <div class="app-card-body">
                                <form class="settings-form" method="POST" action="{{ route('departement.store') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nom" value="{{old('nom')}}" class="form-control" id="setting-input-1" placeholder="Entrez le nom du département" required>
                                    </div>
                                    @error('nom')
